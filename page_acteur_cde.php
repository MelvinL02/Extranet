<?php
   ...
   $acteur = 4;
   $sql = ("SELECT * from comments WHERE actor_id = 4 ORDER BY created_at DESC");
  ...
  <body>
   ...
   <main>
    <section id="presentation_acteur">
        ...
        <h2>CDE</h2>
            <p><p>La CDE (Chambre Des Entrepreneurs) accompagne les entreprises dans leurs démarches de formation. </p>
            <p>Son président est élu pour 3 ans par ses pairs, chefs d’entreprises et présidents des CDE.</p></p>
        </div>
        <div class="like">
