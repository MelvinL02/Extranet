	...
	<body>
		...
		<main>
			<div id="containeur">
				...
				<!-- Formulaire de changement de l'username -->
				<section id="form1">
				...
				<section id="form2">
					...
					<form action="user_update.php" method="post" novalidate>
						...
						<br>
						<p>
							<label for="password"><b>Mon nouveau mot de passe :</b></label>
						</p>
						<br>
						<input type="password" name="password" id="password" required>
						<br>
						<p>
							<label for="repassword"><b>Confirmation du nouveau mot de passe :</b></label>
						</p>
						<br>
				...
				<section id="form3">
					<!-- Formulaire de changement du Nom-->
					<form action="user_update.php" method="post" novalidate>
				...
				<section id="form4">
					<!-- Formulaire de changement du Prénom-->
					<form action="user_update.php" method="post" novalidate>
				...
				<section id="form5">
					<!-- Formulaire de changement de la question/reponse secrète-->
					<form action="user_update.php" method="post" novalidate>
						<h2><u>Changer ma question secrète et ma réponse</u></h2>
						<input type="hidden" name="id_user" value="<?php echo htmlspecialchars($_SESSION["id_user"])?>">
						<br>
						<p>
							<label for="question"><b>Ma nouvelle question secrète :</b></label>
						</p>
						<br>
						...
						<br>
						<p>
							<label for="reponse"><b>Ma nouvelle réponse secrète :</b></label>
						</p>
						<br>
						<input type="text" name="reponse" id="reponse" value="" required>
						<p class="error"></p>
						<p class="confirm"></p>
						<br>
