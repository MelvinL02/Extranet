...
<html lang="fr">
	...
	<body>
		...
		<main>
			<div id="container">
				<!-- Formulaire de récupération de la réponse secrète -->
				<form name="fo" method="post">
					<h1>Mot de passe oublié</h1>
					<div class="center">
						<b>Question secrète :</b>
						<br>
						<br>
					...
					<div class="left">
						...
						<input type="text" name="reponse" required placeholder="Réponse">
					</div>
					<div class="center">
